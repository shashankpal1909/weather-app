    ...
    async function getWeatherData(
        ...
        try {
            const res = await axios.get(
                `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=${units}&appid=${process.env.REACT_APP_WEATHER_API}`
            );
        ...
        try {
            const res = await axios.get(
                `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(
                    city
                )}.json?access_token=${process.env.REACT_APP_LOC_API}&limit=1`
            );
        ...
        <div style={{ marginTop: "100px" }}>
            ...
            >
                ...
                >
                    ...
                    />{" "}
                    <h1 style={{ margin: "0 10px", fontWeight: "bold" }}>
                        Weather
                    </h1>
                </Navbar.Brand>
                <OverlayTrigger
                    placement="bottom"
                    overlay={
                        <Tooltip id={`tooltip-bottom`}>Refresh Weather</Tooltip>
                    }
                >
